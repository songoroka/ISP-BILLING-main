                ...
                <div class="card-body position-relative z-1">
                    <div class="d-flex justify-content-between align-items-sm-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">TSh{{ number_format($billInformationData['today_paid_amount'] ?? 0, 0) }}</h3>
                        </div>
                        <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background: rgba(255,255,255,0.2);">
                    ...
                    <div class="mt-3 pt-2 border-top border-white border-opacity-25">
                        <span class="small fw-medium" style="opacity: 0.9;"><i class="bi bi-calendar3 me-1"></i>{{ __('Total Mo:') }} TSh{{ number_format($billInformationData['paid_amount'] ?? 0, 0) }}</span>
                ...
                <div class="card-body position-relative z-1">
                    <div class="d-flex justify-content-between align-items-sm-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">TSh{{ number_format($billInformationData['hotspot_today'] ?? 0, 0) }}</h3>
                        </div>
                        <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background: rgba(255,255,255,0.2);">
                    ...
                    <div class="mt-3 pt-2 border-top border-white border-opacity-25">
                        <span class="small fw-medium" style="opacity: 0.9;"><i class="bi bi-calendar3 me-1"></i>{{ __('Total Mo:') }} TSh{{ number_format($billInformationData['hotspot_total'] ?? 0, 0) }}</span>
                ...
                <div class="card-body position-relative z-1">
                    <div class="d-flex justify-content-between align-items-sm-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">TSh{{ number_format(($billInformationData['paid_amount'] ?? 0) + ($billInformationData['hotspot_total'] ?? 0), 0) }}</h3>
                        </div>
                        <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background: rgba(255,255,255,0.2);">
                    ...
                    <div class="mt-3 pt-2 border-top border-white border-opacity-25">
                        <span class="small fw-semibold text-warning" style="opacity: 1;"><i class="bi bi-exclamation-triangle-fill me-1"></i>{{ __('Pending Due:') }} TSh{{ number_format($billInformationData['due_amount'] ?? 0, 0) }}</span>
                ...
                <div class="card-body position-relative z-1">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">TSh{{ number_format($resellerData['total_balance'] ?? 0, 2) }}</h3>
                        </div>
                        <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background: rgba(255,255,255,0.15);">
                ...
                <div class="card-body position-relative z-1">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">TSh{{ number_format($resellerData['total_commission'] ?? 0, 2) }}</h3>
                        </div>
                        <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background: rgba(255,255,255,0.15);">
                ...
                requestAnimationFrame(() => {
                    ...
                    if (billEl) {
                        ...
                        const billInformation = {
                            ...
                            tooltip: {
                                y: { formatter: val => 'TSh ' + Math.abs(val).toLocaleString(undefined, {minimumFractionDigits:2}) },
                            },
                        };
                    ...
                    if (billStatusEl) {
                        ...
                        const billByStatus = {
                            ...
                            tooltip: {
                                shared: true,
                                intersect: false,
                                y: { formatter: val => 'TSh ' + val.toLocaleString(undefined,{minimumFractionDigits:2}) },
                            },
                        };
