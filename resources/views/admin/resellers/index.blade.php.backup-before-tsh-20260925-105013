            ...
            <div class="card border-0 shadow-sm rounded-3 reseller-kpi-card" style="background: linear-gradient(135deg, #f0f9ff, #e0f2fe); border: 1px solid #bae6fd !important;">
                <div class="card-body p-3 d-flex align-items-center justify-content-between" style="min-height: 85px;">
                    <div>
                        ...
                        <h4 class="fw-extrabold text-dark mb-0" style="font-family: 'Outfit', 'Inter', sans-serif; letter-spacing: -0.5px; font-size: 1.4rem;">TSh {{ number_format($resellers->sum('total_collected'), 2) }}</h4>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 reseller-kpi-card" style="background: linear-gradient(135deg, #f0fdf4, #dcfce7); border: 1px solid #bbf7d0 !important;">
                <div class="card-body p-3 d-flex align-items-center justify-content-between" style="min-height: 85px;">
                    <div>
                        ...
                        <h4 class="fw-extrabold text-dark mb-0" style="font-family: 'Outfit', 'Inter', sans-serif; letter-spacing: -0.5px; font-size: 1.4rem;">TSh {{ number_format($resellers->sum('total_profit'), 2) }}</h4>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 reseller-kpi-card" style="background: linear-gradient(135deg, #faf5ff, #f3e8ff); border: 1px solid #d8b4fe !important;">
                <div class="card-body p-3 d-flex align-items-center justify-content-between" style="min-height: 85px;">
                    <div>
                        ...
                        <h4 class="fw-extrabold text-dark mb-0" style="font-family: 'Outfit', 'Inter', sans-serif; letter-spacing: -0.5px; font-size: 1.4rem;">TSh {{ number_format($resellers->sum('total_payout'), 2) }}</h4>
                    </div>
                    ...
                    <tbody>
                        @forelse($resellers as $reseller)
                            <tr>
                                ...
                                <td class="text-end text-muted">TSh {{ number_format($reseller->totalCollections(), 2) }}</td>
                                <td class="text-end fw-bold text-success">TSh {{ number_format($reseller->totalProfit(), 2) }}</td>
                                <td class="text-end fw-bold text-success">TSh {{ number_format($reseller->balance, 2) }}</td>
                                ...
                                <td class="text-center pe-4">
                                    <div class="d-inline-flex gap-1">
                                        @if(auth()->user()->hasRole('Super Admin') && $reseller->status === 'active')
                                        @endif
                            ...
                            data.transactions.forEach(trx => {
                                ...
                                const row = `
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold">TSh ${trx.amount}</td>
                                        <td class="text-center">
