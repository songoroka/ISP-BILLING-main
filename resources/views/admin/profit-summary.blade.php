            ...
            <div class="card border-0 shadow-sm rounded-4 profit-kpi-card" style="background: linear-gradient(135deg, #f0fdf4, #dcfce7); border: 1px solid #bbf7d0 !important;">
                <div class="card-body p-3 d-flex align-items-center justify-content-between" style="min-height: 95px;">
                    <div>
                        ...
                        <h4 class="fw-extrabold text-dark mb-1" style="font-family: 'Outfit', 'Inter', sans-serif; letter-spacing: -0.5px; font-size: 1.4rem;">TSh{{ number_format($totalRevenue, 2) }}</h4>
                        <span class="text-muted d-block" style="font-size: 0.65rem; line-height: 1.2;">
                            {{ __('ISP') }}: TSh{{ number_format($collectionRevenue, 2) }} &middot; {{ __('Hotspot') }}: TSh{{ number_format($hotspotRevenue, 2) }}
                        </span>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 profit-kpi-card" style="background: linear-gradient(135deg, #fffbeb, #fef3c7); border: 1px solid #fde68a !important;">
                <div class="card-body p-3 d-flex align-items-center justify-content-between" style="min-height: 95px;">
                    <div>
                        ...
                        <h4 class="fw-extrabold text-dark mb-1" style="font-family: 'Outfit', 'Inter', sans-serif; letter-spacing: -0.5px; font-size: 1.4rem;">TSh{{ number_format($resellerCommissions, 2) }}</h4>
            ...
            <div class="card border-0 shadow-sm rounded-4 profit-kpi-card" style="background: linear-gradient(135deg, #fef2f2, #fee2e2); border: 1px solid #fecaca !important;">
                <div class="card-body p-3 d-flex align-items-center justify-content-between" style="min-height: 95px;">
                    <div>
                        ...
                        <h4 class="fw-extrabold text-dark mb-1" style="font-family: 'Outfit', 'Inter', sans-serif; letter-spacing: -0.5px; font-size: 1.4rem;">TSh{{ number_format($totalExpenses, 2) }}</h4>
                        <span class="text-muted d-block" style="font-size: 0.65rem; line-height: 1.2;">
                ...
                <div class="card-body p-3 d-flex align-items-center justify-content-between" style="min-height: 95px;">
                    <div>
                        ...
                        <h4 class="fw-extrabold mb-1" style="font-family: 'Outfit', 'Inter', sans-serif; letter-spacing: -0.5px; font-size: 1.4rem; color: {{ $isProfitable ? '#0369a1' : '#be185d' }};">
                            {{ $isProfitable ? '' : '-' }}TSh{{ number_format(abs($netProfit), 2) }}
                        </h4>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="card-body px-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                        ...
                        <span class="fw-semibold text-success">+ TSh{{ number_format($collectionRevenue, 2) }}</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                        <span class="small text-muted">{{ __('Hotspot Sales') }}</span>
                        <span class="fw-semibold text-success">+ TSh{{ number_format($hotspotRevenue, 2) }}</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom bg-success-subtle rounded-3 px-2">
                        ...
                        <span class="fw-bold text-success">TSh{{ number_format($totalRevenue, 2) }}</span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                        ...
                        <span class="fw-semibold text-danger">− TSh{{ number_format($resellerCommissions, 2) }}</span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                        ...
                        <span class="fw-semibold text-danger">− TSh{{ number_format($expensesByCategory[$key] ?? 0, 2) }}</span>
                    </div>
                    @endforeach
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom bg-danger-subtle rounded-3 px-2 mt-1">
                        ...
                        <span class="fw-bold text-danger">TSh{{ number_format($resellerCommissions + $totalExpenses, 2) }}</span>
                    </div>
                ...
                <div class="card-body d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="mt-3 w-100">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="small fw-semibold">TSh{{ number_format($amount, 2) }}</span>
                        </div>
                        @endif
                        @endforeach
                    </div>
                                ...
                                <tbody>
                                    @foreach($itemPurchases as $item)
                                        <tr>
                                            ...
                                            <td class="small fw-bold text-dark text-end py-2 border-bottom-0">TSh{{ number_format($item->amount, 2) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    @foreach($employeeSalaries as $bill)
                                        <tr>
                                            ...
                                            <td class="small fw-bold text-dark text-end py-2 border-bottom-0">TSh{{ number_format($bill->amount, 2) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
        ...
        new Chart(trendCtx, {
            ...
            options: {
                ...
                scales: {
                    y: {
                        grid: { color: '#f1f5f9' },
                        ticks: { callback: v => 'TSh' + v.toLocaleString(), font: { size: 11 } }
                    },
