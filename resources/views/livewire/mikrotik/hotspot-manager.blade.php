    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-3">
            <div class="stat-card" style="background:linear-gradient(135deg,#0ea5e9,#0284c7)">
                ...
                <div>
                    <div class="stat-value">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($monthIncome,0) }}</div>
        ...
        <div class="col-lg-3">
            <div class="card border-0 shadow-sm mb-3">
                ...
                <div class="card-body text-center py-4">
                    <div style="font-size:2.4rem;font-weight:900;color:#16a34a">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($todayIncome,2) }}</div>
                    ...
                    <form wire:submit.prevent="generateVouchers" id="voucher-gen-form">
                        <div class="mb-2">
                            ...
                            @if($v_profile)
                                ...
                                @if($localPkg)
                                    <div class="x-small text-success mt-1"><i class="bi bi-check-circle"></i> {{ __('Linked to DB Package:') }} {{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ $localPkg->price }}</div>
                                @endif
                            @endif
                        </div>
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-6">
                                <label class="form-label">{{ __('Price') }} ({{ siteUrlSettings('site_currency') ?? 'TSh' }})</label>
                ...
                <div class="card-body p-0">
                    <table class="table table-sm align-middle mb-0 hs-table">
                        ...
                        <tr wire:key="batch-row-{{ $b->batch_name }}-{{ $loop->index }}">
                            ...
                            <td><small>{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($b->price,0) }}</small></td>
            ...
            <div class="card mt-3 border-0 shadow-sm">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom small">
                        ...
                        <span class="badge bg-light text-dark border">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($pkg->price,0) }}</span>
                    </div>
                    @empty
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form wire:submit.prevent="recordSale">
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-7">
                                <label class="form-label">{!! __('Amount (:currency) :info', ['currency' => siteUrlSettings('site_currency') ?? 'TSh', 'info' => '<span class="text-danger">*</span>']) !!}</label>
            ...
            <div class="row g-2 mb-3">
                <div class="col-4">
                    <div class="card text-center py-2 border-start border-4 border-success">
                        <div class="fw-bold fs-5 text-success">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($todayIncome,2) }}</div>
                        <small class="text-muted">{{ __('Today') }}</small>
                    </div>
                </div>
                <div class="col-4">
                    <div class="card text-center py-2 border-start border-4 border-primary">
                        <div class="fw-bold fs-5 text-primary">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($monthIncome,2) }}</div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover align-middle mb-0 hs-table data-table" wire:key="tbl-sales-{{ $selectedRouter }}">
                            ...
                            <tr wire:key="sale-{{ $s->id }}">
                                ...
                                <td><strong class="text-success">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($s->amount,2) }}</strong></td>
                            ...
                            <tfoot class="table-light">
                                <tr>
                                    ...
                                    <td><strong class="text-success">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($sales->sum('amount'),2) }}</strong></td>
                                    <td colspan="4"></td>
                                </tr>
                            </tfoot>
                            @endif
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-4">
            <div class="card text-center py-3 border-0 shadow-sm">
                <div style="font-size:1.8rem;font-weight:800;color:#16a34a">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($r['total'] ?? 0, 2) }}</div>
        ...
        <div class="col-md-4">
            <div class="card text-center py-3 border-0 shadow-sm">
                <div style="font-size:1.8rem;font-weight:800;color:#f59e0b">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ $r['count'] > 0 ? number_format(($r['total'] ?? 0) / $r['count'], 2) : '0.00' }}</div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm align-middle mb-0 hs-table data-table">
                            ...
                            <tr>
                                ...
                                <td><strong class="text-success">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($dayTotal,2) }}</strong></td>
                                <td>
                                    @if($grandTotal > 0)
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="px-3 py-2 border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <strong class="text-success small">{{ siteUrlSettings('site_currency') ?? 'TSh' }}{{ number_format($bp['total'],2) }}</strong>
                    </div>
                    @empty
                            ...
                            <div class="voucher-body">
                                ...
                                <div class="voucher-info">
                                    ...
                                    <div class="voucher-info-item" style="width:100%;text-align:center;">
                                        ...
                                        <span class="voucher-info-value">{{ siteUrlSettings('site_currency') ?? 'TSh' }}${v.price}</span>
                                    </div>
                                </div>
