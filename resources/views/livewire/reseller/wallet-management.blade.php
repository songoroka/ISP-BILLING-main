            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 text-white" style="background: linear-gradient(135deg, #1e293b, #0f172a);">
                <div class="card-body p-4 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold mb-1">TSh{{ number_format($reseller->balance, 2) }}</h3>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body p-4 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-dark mb-1">TSh{{ number_format($totalCommissionEarned, 2) }}</h3>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body p-4 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-dark mb-1">TSh{{ number_format($totalUpfrontCommission, 2) }}</h3>
                    </div>
                    <div class="mt-2 text-muted small" style="font-size: 0.72rem;">
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body p-4 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-dark mb-1">TSh{{ number_format($totalCommissionPaid, 2) }}</h3>
                    </div>
                    <div class="mt-2 text-muted small" style="font-size: 0.72rem;">
