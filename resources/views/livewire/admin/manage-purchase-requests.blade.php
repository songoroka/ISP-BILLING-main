                        ...
                        <tbody>
                            ...
                            <tr wire:key="req-{{ $req->id }}">
                                ...
                                <td>
                                    ...
                                    <div class="fw-bold text-dark mt-1" style="font-size: 0.95rem;">TSh{{ number_format($req->price, 0) }}</div>
                                </td>
                                <td>
                    ...
                    <div class="modal-body px-4 pt-3">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fw-bold text-dark fs-6"><span class="badge bg-success-subtle text-success border border-success">{{ $selectedRequest->package_name }}</span> (TSh{{ number_format($selectedRequest->price, 0) }})</div>
                            </div>
                            <div class="col-12">
