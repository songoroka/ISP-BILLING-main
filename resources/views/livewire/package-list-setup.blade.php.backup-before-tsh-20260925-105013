                        ...
                        <form wire:submit.prevent="createPackage">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 col-12">
                                    <label class="form-label fw-semibold text-dark small">
                                        {{ __('Service Type') }}
                                        <span class="text-muted small">(Where this package can be used)</span>
                                    </label>
                                    <select class="form-select form-select-sm shadow-xs @error('service_type') is-invalid @enderror"
                                            wire:model.defer="service_type"
                                            style="border-radius: 6px;">
                                        <option value="both">{{ __('PPP + Hotspot') }}</option>
                                        <option value="ppp">{{ __('PPP Only') }}</option>
                                        <option value="hotspot">{{ __('Hotspot Only') }}</option>
                                    </select>
                                    @error('service_type')
                                ...
                                <div class="col-md-6 col-12">
                                    <label class="form-label fw-semibold text-dark small">
                                        {{ __('Validity Type') }}
                                        <span class="text-muted small">(Hotspot timer)</span>
                                    </label>
                                    <select class="form-select form-select-sm shadow-xs @error('validity_type') is-invalid @enderror"
                                            wire:model.defer="validity_type"
                                            style="border-radius: 6px;">
                                        <option value="">{{ __('-- Select Validity --') }}</option>
                                        <option value="realtime">{{ __('Realtime') }}</option>
                                    </select>
                                    @error('validity_type')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="input-group input-group-sm shadow-xs">
                                        ...
                                        <input type="text"
                                               ...
                                               wire:model.defer="validity_duration"
                                               placeholder="30m, 2h, 1d, 7d"
                                               maxlength="50"
                                               style="border-radius: 0 6px 6px 0;">
                                    </div>
                                    <small class="text-muted">
                                        {{ __('Examples: 30m = 30 minutes, 2h = 2 hours, 1d = 1 day, 7d = 7 days') }}
                                    </small>
                                ...
                                <div class="col-md-6 col-12">
                                    <label class="form-label fw-semibold text-dark small">{!! __('Monthly Price (TSh) :info', ['info' => '<span class="text-danger">*</span>']) !!}</label>
                                ...
                                <div class="col-md-8 col-12 d-flex flex-column justify-content-end gap-2 pt-2">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox"
                                               wire:model.live="ttl_mangle_enabled"
                                               id="ttl_mangle_enabled">
                                        <label class="form-check-label text-muted small" for="ttl_mangle_enabled">
                                            <i class="bi bi-shield-lock text-warning me-1"></i>{{ __('Enable TTL Mangle') }}
                                        </label>
                                    </div>

                                    @if($ttl_mangle_enabled)
                                        ...
                                        <div class="small text-muted mt-1">
                                            ...
                                            {{ __('TTL is applied only to users of this package.') }}
                                        </div>
                                    @endif
                                </div>
                            ...
                            <tbody wire:sortable="updateSortOrder">
                                @forelse ($packagesData ?? [] as $package)
                                    <tr wire:sortable.item="{{ $package['id'] }}" wire:key="pkg-{{ $package['id'] }}" class="{{ $package['is_featured'] ? 'table-success-subtle border-success-subtle' : '' }}">
                                        ...
                                        <td class="fw-semibold">{{ number_format($package['price'], 0) }}TSh</td>
