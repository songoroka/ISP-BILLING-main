    ...
    public function __construct(string $host, int $port, string $username, string $password, int $timeout = 20)
{
    ...
    // Use the exact RouterOS username stored in the database.
    // The +ct suffix is intentionally not added because direct
    // phpseclib authentication with the configured username works.
