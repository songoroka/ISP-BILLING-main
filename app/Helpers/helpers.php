...
if (! function_exists('currentReseller')) {
    /**
     * Resolve the reseller belonging to the authenticated reseller user.
     * Super Admin users never operate through a reseller context.
     */
